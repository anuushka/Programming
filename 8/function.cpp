...
void Cube::rotate_clock(char choice)
{
  if (choice=='w')
  {
    cout<<"White"<<endl;
...
void Cube::inv_alg(char a,char b,char c)
{
...
void Cube::white_bottom_inverted(char q)
{
...
void Cube::middle_place_left_alg(char left,char center)
{
    rotate_clock('y');rotate_clock('y');rotate_clock('y');
...
void Cube::middle_place_right_alg(char center,char right)
{
    rotate_clock('y');
    rotate_clock(right);
    rotate_clock('y');rotate_clock('y');rotate_clock('y');
...
void Cube::yellow_cross_algorithm()
{
        rotate_clock('r');
        rotate_clock('y');
        rotate_clock('g');
...
void Cube::solve_yellow_corners()
{
...
void Cube::yellow_corner_orientation_algorithm()
{
    rotate_clock('g');rotate_clock('g');rotate_clock('g');
    rotate_clock('r');
    rotate_clock('g');rotate_clock('g');rotate_clock('g');
...
void Cube::yellow_corner_orientation()
{
...
void Cube::yellow_edges_colour_arrangement_right()
{
...
void Cube::yellow_edges_colour_arrangement_left()
{
    rotate_clock('r');rotate_clock('r');
    rotate_clock('y');
    rotate_clock('b');
...
void Cube::yellow_edges_colour_arrangement()
{
    while(red[2]!='r')
    {
        rotate_clock('r');
